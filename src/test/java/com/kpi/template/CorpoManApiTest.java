...
public class CorpoManApiTest {
    public static void main(String[] args) {
        ...
        System.out.println("hash code CorpoManApi CLASS=" + CorpoManApi.class.hashCode());
    ...
    corpoManApi2 = corpoManApi1;
        System.out.println("hashCode corpoManApi1=" + corpoManApi1.hashCode());
        System.out.println("hashCode corpoManApi2=" + corpoManApi2.hashCode());
        corpoManApi2 = corpoManApi1;
