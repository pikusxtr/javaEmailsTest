...
public class ParallelMethodTest3
{
    @BeforeClass
    public void beforeClass(){
        System.out.println("Before class3 method executed");
    }

    @BeforeMethod
    public void beforeMethod() {
        long id = Thread.currentThread().getId();
        System.out.println("Before test-method3. Thread id is: " + id);
    }
    ...
    public void afterMethod() {
        long id = Thread.currentThread().getId();
        System.out.println("After test-method3. Thread id is: " + id);
    }
}