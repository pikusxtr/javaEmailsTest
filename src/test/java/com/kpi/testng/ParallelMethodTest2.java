...
public class ParallelMethodTest2
{
    ...
    public void beforeClass(){
        System.out.println("Before class2 method executed");
    }

    @BeforeMethod
    public void beforeMethod() {
        long id = Thread.currentThread().getId();
        System.out.println("Before test-method2. Thread id is: " + id);
    }
    ...
    public void afterMethod() {
        long id = Thread.currentThread().getId();
        System.out.println("After test-method2. Thread id is: " + id);
    }
}